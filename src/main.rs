...
impl State {
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(4, WHITE, BLACK, "Slain by a monster, your hero's \
        journey has come to a premature end.");
        ctx.print_color_centered(5, WHITE, BLACK, "The Amulet o Yala remains \
        unclaimed, and your home town is not saved.");
        ctx.print_color_centered(8, YELLOW, BLACK, "Don't worry, you can always \
        try again with a new hero.");
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        and feel its power course through your veins.");
        ctx.print_color_centered(5, WHITE, BLACK, "Your town is saved, and you can \
